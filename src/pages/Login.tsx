...
const Login = () => {
  ...
  return (
    <div className="min-h-screen gradient-dark relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="glass-card rounded-2xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-foreground mb-2">Bun venit</h1>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-foreground/80">
              Nu ai cont?{" "}
              <Link to="/signup" className="text-primary hover:text-primary/90 underline font-semibold">
                Creează unul aici
              </Link>
            </p>
          </div>
