      ...
      <main className="p-4 md:p-8 space-y-6">
        ...
        <header className="glass-card">
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              <div className="glass-subtle rounded-xl p-4 flex-1">
                <div className="flex items-center gap-2">
                  <Clock className="w-5 h-5 text-muted-foreground" />
                  <span className="text-sm">Leave now</span>
                </div>
              </div>
              <button className="glass-button font-semibold hover:scale-105">
                Find Routes
              </button>
            </div>
          </div>
        ...
        <section className="space-y-4">
          ...
          {routeResults.map((route, index) => (
            <div
              key={index}
              className="glass-card hover:glass-strong cursor-pointer group"
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {route.badge && (
                      <span className="glass-subtle rounded-full px-3 py-1 text-xs font-medium text-primary">
                        {route.badge}
                      </span>
                    )}
                  </div>
              ...
              {/* Action Button */}
              <button className="mt-4 w-full glass-subtle rounded-xl py-3 font-semibold group-hover:glass transition-all">
                View Details
              </button>
            </div>
          ))}
